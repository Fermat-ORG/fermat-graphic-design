...
#### 4. ¿Cuál es la  misión del equipo de **Diseño Gráfico**?
...
* **a** Estar dentro del repositorio del [ administrador] (https://github.com/arnaldos/fermat-graphic-design). ahí se puede visualizar en la esquina inferior derecha, un botón que lleva por nombre **Clone in Desktop**. 
...
* **e** Aparecerá un botón en la esquina superior izquierda con un símbolo **“+”** hay que pulsarlo, se abrirá una ventana, esta muestra 3 botones adicionales que son los siguientes;
...
* **h** Debemos seleccionar el repositorio con el que se va a trabajar, para el caso será  
 **Nombre-del-usuario/fermat-graphics-design**.

 
* **i** Aparecerá un botón de **Clone Nombre-del-usuario/fermat-graphics-design** en la parte inferior de la ventana, 
 **Pulsamos el botón**.
...
Esto no se debe hacer, solo debe existir un archivo llamado **Logo-Fermat**. Si hay una modificación sobre el archivo simplemente se sustituye. Ya que de ser necesario trabajar con una versión anterior del archivo,  **github** permite recuperar la versión que necesitemos.
...
El diseñador podrá asignarse el issue, en caso de no tener ninguno, también puede colaborar en cualquier issue que este abierto. 
...
*	Si seleccionas cualquiera de ellos podrás realizar **post**, acerca del caso estés trabajando o no en ello. Se puede apreciar que tiene un espacio para dejar comentarios.

*	Muchos de ellos ya han sido posteados por lo que se puede ver los avances que se han realizado.
